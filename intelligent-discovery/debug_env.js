...
const current = ['AI21_API_KEY', 'ARTIFICIALANALYSIS_API_KEY', 'COHERE_API_KEY', 'GOOGLE_API_KEY', 'GEMINI_API_KEY', 'GROQ_API_KEY', 'HUGGINGFACE_API_KEY', 'MISTRAL_API_KEY', 'OPENROUTER_API_KEY', 'TOGETHER_API_KEY'];
